...
namespace svm_compute
{
    public static class extensions
    {
        ...
        public static bool is_connected(this TcpClient client)
        {
            return client != null && client.Connected && client.GetState() == TcpState.Established && client.Client.is_socket_connected();
        }
        ...
        public static bool is_socket_connected(this Socket client)
        {
        ...
        public static List<T> Rotate<T>(this List<T> list, int offset)
        {
            ...
            //if (program.write_console_log) program.WriteLine(offset);
